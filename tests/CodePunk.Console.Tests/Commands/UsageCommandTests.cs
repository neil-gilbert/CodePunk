...
public class UsageCommandTests
{
    ...
    var s = new InteractiveChatSession(sessionService.Object, messageService.Object, llmService.Object, toolService.Object, logger.Object, null, new ChatSessionEventStream());
